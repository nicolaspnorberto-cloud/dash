...
function instalarAutomacoesV65() {
  ...
  Logger.log(
    'V6.5.3 instalada: HC+LM 30 min | GEROT Packed+Forecast INTER-SOC 30 min | E-mails 5 min. ' +
...
function sincronizarGerotV65() {
  ...
  try {
    ...
    Logger.log(
      'V6.5.3 GEROT OK: ' + data.processedRows + ' linhas Packed agregadas | ' +
...
function lerPackedGerotV65_(ss) {
  if (!ss) {
    throw new Error('V6.5.3: planilha GEROT não foi aberta.');
  }
...
/**
 * V6.5.3 — teste objetivo do Forecast INTER-SOC.
...
function testarForecastInterSocV652(dataTeste) {
  ...
  Logger.log('Forecast INTER-SOC V6.5.3 para ' + dateKey + ':');
...
/**
 * V6.5.3 — valida REAL e FORECAST somente INTER-SOC.
 *
