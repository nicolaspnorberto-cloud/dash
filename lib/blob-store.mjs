...
const cacheable = /^misscan\/(?:hc|history-meta|gerot|producao-real|calendarizacao|live)\.json$|^misscan\/history\/\d{4}-\d{2}\.json$|^misscan\/history-shards\/\d{4}-\d{2}-\d{2}\.json$|^misscan\/history-days\/\d{4}-\d{2}-\d{2}\.json$/;
let version = 0;
let runtimeEnv = {};
